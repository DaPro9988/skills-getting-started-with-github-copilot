              ...
              <ul class="participants-list" style="list-style: none; padding-left: 0;">
                ${details.participants.map(email => `
                  <li class="participant-item" style="display: flex; align-items: center; gap: 0.5em;">
                    <span>${email}</span>
                    <button class="delete-participant" title="Remove participant" data-activity="${name}" data-email="${email}" style="background: none; border: none; color: #c00; cursor: pointer; font-size: 1.2em;">✖️</button>
                  </li>
                `).join("")}
              </ul>
            </div>
